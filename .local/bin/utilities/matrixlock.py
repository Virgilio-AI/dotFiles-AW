...
def overlay_matrix_on_workspace(ws_name, port, delay, terminal, visible_wss):
	...
	terminal_command = f'exec "st -name matrixlock -e {pid_server_command}"'
	# terminal command
	if terminal == 'st':
...
if __name__ == '__main__':
	...
	parser.add_argument(
		'--terminal',help='The terminal to use (if using uxrvt, please set the instance to be fullscreen in conf)', default='st'
	)
